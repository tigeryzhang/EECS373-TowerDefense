...
typedef struct {
	...
	void (*prerender)(Scene *scene, struct AppContext *app, RenderView *view, RenderData* data);
	void (*render)(Scene *scene, struct AppContext *app, RenderView *view, RenderData* data);
