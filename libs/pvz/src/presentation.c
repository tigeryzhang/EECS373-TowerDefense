...
static const PaletteRgb palette_rgb[] = {
	...
	[RENDER_PALETTE_TILE_LIGHT] = {56, 77, 28},
	[RENDER_PALETTE_TILE_DARK] = {6, 26, 2},
	...
	[RENDER_PALETTE_ZOMBIE] = {46, 51, 48},
	[RENDER_PALETTE_CONE] = {255, 161, 62},
	[RENDER_PALETTE_BUCKET] = {34, 79, 97},
	[RENDER_PALETTE_PROJECTILE] = {80, 206, 68},
	[RENDER_PALETTE_WARNING] = {203, 72, 56},
	[RENDER_PALETTE_SUCCESS] = {65, 170, 95},
	[RENDER_PALETTE_ART_0] = {78, 87, 76},
	[RENDER_PALETTE_ART_1] = {23, 26, 23},
	[RENDER_PALETTE_ART_2] = {128, 93, 62},
	[RENDER_PALETTE_ART_3] = {84, 109, 138},
	[RENDER_PALETTE_ART_4] = {99, 18, 18},
	[RENDER_PALETTE_ART_5] = {61, 171, 87},
	[RENDER_PALETTE_ART_6] = {173, 75, 14},
